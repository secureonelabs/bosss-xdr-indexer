...
- Include Reporting plugin in BOSSS XDR Indexer by default [(#1008)](https://github.com/wazuh/wazuh-indexer/pull/1008)
- Make BOSSS XDR Indexer roles reserved [(#1012)](https://github.com/wazuh/wazuh-indexer/pull/1012)
- Add Cross-Cluster Search environment [(#1034)](https://github.com/wazuh/wazuh-indexer/pull/1034)
- Add Security Analytics fork to BOSSS XDR Indexer packages [(#1188)](https://github.com/wazuh/wazuh-indexer/pull/1188)
